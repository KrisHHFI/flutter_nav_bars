...
class NavBarFive extends StatefulWidget {
  const NavBarFive({super.key});

  @override
  NavBarFiveState createState() => NavBarFiveState();
}

class NavBarFiveState extends State<NavBarFive> {
            ...
            children: [
              ...
              Container(
                padding: EdgeInsets.fromLTRB(
                    smallPadding, smallPadding, smallPadding, smallPadding),
